...
public class ThreeInputTwonumSubstractionlessthan20 {
	...
	public static void main(String[] args) {
		...
		// The condition checks if the absolute difference between the numbers is
		// greater than or equal to 20
//		System.out.println((Math.abs(x - y) >= 20 || Math.abs(y - z) >= 20 || Math.abs(z - x) >= 20));
		
		System.out.println(((x - y) >= 20 ||(y - z) >= 20 || (z - x) >= 20));
